  ...
  return (
    <div className="w-full max-w-md">
      ...
      <div className="bg-white dark:bg-[#0d1020] rounded-2xl shadow-sm border border-gray-100 dark:border-[#1e2030] p-8">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-1">Nova senha</h2>
        <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">Defina uma nova senha para sua conta. Use pelo menos 8 caracteres.</p>
        ...
        <form action={action} className="space-y-4">
          <div>
            <label htmlFor="password" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Nova senha</label>
            <input
              id="password" name="password" type="password" autoComplete="new-password" required minLength={8}
              className="w-full px-4 py-2.5 rounded-lg border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white text-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:border-transparent transition"
