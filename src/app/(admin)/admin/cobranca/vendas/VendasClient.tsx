  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-center gap-2 text-sm text-gray-400">
        ...
        <span>
          Mostra só transações comerciais (compra ou pacote) liberadas via webhook do Asaas. Acesso concedido manualmente aparece em{' '}
          <a href="/admin/cobranca/acessos" className="underline hover:text-gray-700 transition" style={{ color: 'var(--brand)' }}>
            Acessos
          </a>
          , não aqui.
        </span>
