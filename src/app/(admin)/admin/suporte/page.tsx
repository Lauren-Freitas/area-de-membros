...
const faq = [
  ...
  },
  {
    ...
    a: 'Vá em Conteúdo → Criar produto, preencha as informações e salve. Depois copie o UUID do produto na URL e cole no campo de referência externa do link de pagamento no Asaas.',
  },
  {
  ...
  },
  {
    ...
    a: 'Use a API REST disponível em Integrações → Asaas & API Docs. Crie um nó HTTP Request com a URL do endpoint, adicione o header x-api-key com a chave de API e envie o body em JSON.',
  },
  {
    q: 'Como emitir um certificado para um membro?',
    a: 'Vá em Conteúdo → Certificados, localize o membro e clique em "Emitir certificado". O membro verá o certificado disponível na área de membros.',
  },
]
    ...
    <div className="max-w-2xl space-y-6">
      ...
      <div className="bg-card rounded-2xl border border-gray-100 p-6">
        ...
        {(supportWhatsapp || supportEmail) ? (
          ...
          <p className="text-sm text-gray-400">Configure o WhatsApp e/ou e-mail de suporte em Aparência.</p>
        )}
      </div>
