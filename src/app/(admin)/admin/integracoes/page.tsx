...
const apps = [
  ...
  },
  {
    id: 'documentacao',
    name: 'Documentação',
    desc: 'Endpoints, eventos, exemplos de código',
    href: '/admin/integracoes/documentacao',
    external: false,
    icon: (
      <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    id: 'automacoes',
    name: 'Automações',
    desc: 'Como os fluxos automáticos funcionam',
    href: '/admin/integracoes/automacoes',
    external: false,
    icon: (
      <svg className="w-10 h-10" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    id: 'asaas',
    name: 'Asaas',
    desc: 'Webhook de pagamento confirmado',
