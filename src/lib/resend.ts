      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#fff;border-radius:16px;overflow:hidden;border:1px solid #e5e7eb;max-width:600px;width:100%">
        <tr>
          <td style="background:#059669;padding:32px 40px;text-align:center">
            <p style="margin:0;color:#d1fae5;font-size:13px;font-weight:600;letter-spacing:0.05em;text-transform:uppercase">Thiago Cantalovo · Nutricionista</p>
        ...
        <tr>
          <td style="padding:40px">
            ...
            <table cellpadding="0" cellspacing="0"><tr><td>
              <a href="${inviteLink}" style="display:inline-block;background:#059669;color:#fff;font-size:15px;font-weight:600;text-decoration:none;padding:14px 32px;border-radius:10px">
