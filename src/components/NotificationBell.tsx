...
export function NotificationBell({ notifications: initial, unreadCount: initialCount }: Props) {
  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      {open && (
        <div className="absolute right-0 top-10 w-80 bg-card rounded-2xl shadow-xl border border-gray-100 dark:border-[#1e2030] z-50 overflow-hidden">
          <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100 dark:border-[#1e2030]">
            ...
            {unread > 0 && (
              <button onClick={handleMarkAll} className="text-xs font-medium transition" style={{ color: 'var(--brand)' }}>
