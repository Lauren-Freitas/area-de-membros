...
/**
 * Player focado só em reprodução (Etapa 7) -- navegação entre aulas e
 * progresso vivem fora daqui agora (LessonCompletionActions), pra não
 * duplicar o que a sidebar de módulo já mostra.
 */
export function LessonVideoPlayer({ url }: Props) {
  ...
  return (
    <>
      ...
      <div className="bg-card rounded-2xl border border-gray-100 dark:border-[#1e2030] overflow-hidden">
        ...
        {/* Toolbar -- só controles de reprodução */}
        <div className="flex items-center justify-end gap-1 px-4 py-2.5 bg-gray-50 dark:bg-[#0a0d1a]">
